export default function CreateTaskForm({ form, onChange, onSubmit, onClose }) {
  return (
    <form onSubmit={onSubmit} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-200">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-600">Add a new task to your workspace.</p>
        </div>
      ...
      <button
        type="submit"
        className="mt-6 rounded-xl bg-slate-950 px-4 py-2 text-sm font-semibold text-white transition hover:bg-slate-800"
      >
        Create task
      </button>
    </form>
